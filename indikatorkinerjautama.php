...
?>
  ...
  <div class="container-kebencanaan mt-4">
    <h1 class="h1-container d-none d-md-block">Indikator Kinerja Utama BPBD</h1>
  </div>

  <!-- TERLIHAT PADA HP -->
  <div class="container-kebencanaan mt-4">
    <h3 class="h1-container  d-block d-sm-none" style="margin-bottom: 20px;">Indikator Kinerja Utama BPBD</h3>
  </div>
  <!-- JUDUL END -->
...
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
  ...
  <div class="card-body" align="center">
    <h5 class="card-title">Document IKU. BPBD</h5>
    <p class="card-text">Indikator Kinerja Utama BPBD Kota Pekanbaru</p>
    <a href="https://drive.google.com/file/d/1B2IjdFmPon3q2MCmI7-HKi_E2GoZ9mPT/view?usp=share_link" class="btn btn-primary">
      Buka Document</a>
  </div>
</div>
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
