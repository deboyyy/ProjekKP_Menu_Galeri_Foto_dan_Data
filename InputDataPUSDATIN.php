...
<div class="container-kebencanaan mt-4">
  <h1 class="h1-container">Input Data PUSDATIN</h1>
</div>
<div class="row justify-content-center pt-5">

  <div class="col-6 ">
    <form action="InputDataPUSDATIN.php" method="post" enctype="multipart/form-data">
      <div class="mb-3">
      ...
      <a class="btn btn-outline-danger" href="viewDataPUSDATIN" role="button">Cancel</a>
    </form>
  </div>
</div>
<?php
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  try {
    ...
    $sql = "INSERT INTO pusdatin (file_name, file_type, file_size, file_path, perihal, deskripsi, user_id, upload_date) VALUES ('$file_name', '$file_type', $file_size, '$file_path', '$perihal', '$deskripsi', $user_id, '$upload_date')";
    // Execute the query
