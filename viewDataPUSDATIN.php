...
<div class="container-kebencanaan mt-4">
  <h1 class="h1-container">Data PUSDATIN</h1>
</div>
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          ...
          if (isset($_SESSION['user_id'])) {
            ...
            <div class="d-flex flex-column gap-2">
              ...
              <a href="hapus?direct=viewDataPUSDATIN&table=pusdatin&fileid=<?php echo $row["file_id"] ?>"
                class="btn btn-outline-danger d-block" style="border-radius: 4px;" name="<?php echo $row['file_id'] ?>">
                Delete
              </a>
            </div>
            <?php
