...
?>
  ...
  <div class="container-kebencanaan ">
    <h1 class="h1-container">Renja BPBD</h1>
  </div>
  <!-- JUDUL END -->
...
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
  ...
  <div class="card-body" align="center">
    <h5 class="card-title">Document Renja BPBD</h5>
    <p class="card-text">Renja BPBD Provinsi Riau Tahun 2021 adalah dokumen perencanaan</p>
    <a href="https://drive.google.com/file/d/1JWW81JYh-jrwTp8BGN20-ng-JnW8cK6z/view?usp=share_link" class="btn btn-primary">
      Buka Document</a>
  </div>
</div>
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
