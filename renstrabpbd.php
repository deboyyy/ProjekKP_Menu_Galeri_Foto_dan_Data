...
?>
  <!-- NAVIGATION BAR END -->
    ...
    <div class="container-kebencanaan ">
      <h1 class="h1-container">Renstra BPBD</h1>
    </div>
    <!-- JUDUL END -->
...
<div class="row justify-content-center m-3 mt-4 ">
  <div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
    ...
    <div class="card-body" align="center">
      <h5 class="card-title">Document Renstra BPBD</h5>
      <p class="card-text">Rencana Strategi Badan Penanggulangan Bencana Daerah Kota Pekanbaru</p>
      <a href="https://drive.google.com/file/d/1OTgni3_nU7wnhp6trNzLswsFpuJfkWBs/view?usp=share_link" class="btn btn-primary">
        Buka Document</a>
    </div>
  </div>
    <div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
