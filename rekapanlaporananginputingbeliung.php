...
?>
  ...
  <div class="container-kebencanaan mt-4">
    <h1 class="h1-container d-none d-md-block">Laporan Angin Puting Beliung</h1>
  </div>

  <!-- TERLIHAT PADA HP -->
  <div class="container-kebencanaan mt-4">
    <h3 class="h1-container  d-block d-sm-none" style="margin-bottom: 20px;">Laporan Angin Puting Beliung</h3>
  </div>

  <div class=" d-none d-md-block">
    <div class="row justify-content-center m-3 ">
      <div class="col" style="margin-left: 45px;">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/1.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This content is a little bit longer.</p>
            <a href="frontend/images/1.jpeg" class="btn btn-primary">Read More</a>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/2.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
            <a href="frontend/images/2.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/3.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This card has even longer content than the first to show that equal height action.</p>
            <a href="frontend/images/3.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/4.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This content is a little bit longer.</p>
    ...
    <div class="row justify-content-center m-3 ">
      <div class="col" style="margin-left: 45px;">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/5.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This content is a little bit longer.</p>
            <a href="frontend/images/5.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/6.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
            <a href="frontend/images/6.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/7.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This card has even longer content than the first to show that equal height action.</p>
            <a href="frontend/images/7.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
      ...
      <div class="col">
        <div class="card h-100" style="width: 18rem;display:  flex;">
          <img src="frontend/images/8.jpeg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
              content. This content is a little bit longer.</p>
            <a href="frontend/images/8.jpeg" class="btn btn-primary">Read More</a>
          </div>
          <div class="card-footer">
            <small class="text-muted">Last updated 3 mins ago</small>
          </div>
...
?>
  <!-- TERLIHAT DI HP -->
  <div class="row justify-content-center  d-block d-sm-none" style="margin-left: 40px;">
    <div class="col">
      <div class="card h-100" style="width: 18rem;display:  flex; margin-bottom: 20px;  margin-top: 30px;">
        <img src="frontend/images/1.jpeg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional
    ...
    <div class="col">
      <div class="card h-100" style="width: 18rem;display:  flex; margin-bottom: 20px;">
        <img src="frontend/images/2.jpeg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
  ...
  <div class="row justify-content-center d-block d-sm-none" style="margin-left: 40px; margin-bottom: 40px;">
    <div class="col">
      <div class="card h-100" style="width: 18rem;display:  flex; margin-bottom: 20px;">
        <img src="frontend/images/5.jpeg" class="card-img-top" alt="...">
        <div class="card-body">
