...
?>
  ...
  <div class="container-kebencanaan mt-4">
    <h1 class="h1-container">Rencana Aksi BPBD</h1>
  </div>
  <!-- JUDUL END -->
...
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
  ...
  <div class="card-body" align="center">
    <h5 class="card-title">Rencana Aksi BPBD Bengkalis</h5>
    <p class="card-text">Rencana Aksi Badan Penanggulangan Bencana Daerah Kota Pekanbaru</p>
    <a href="https://drive.google.com/file/d/1Q5wbUtrZAEPHnisYe04j0Vq4jhZTkPlS/view?usp=share_link" class="btn btn-primary">
      Buka Document</a>
  </div>
</div>
<div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
