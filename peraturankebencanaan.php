...
?>
  ...
  <div class="container-kebencanaan mt-4">
    <h1 class="h1-container">Peraturan Kebencanaan</h1>
  </div>
  <!-- JUDUL END -->
  ...
  <div class="row justify-content-center m-3 mt-4 ">
    <div class="card col-4 m-2 shadow my-5 py-3" style="width: 18rem; flex;">
      ...
      <div class="card-body" align="center">
        <h5 class="card-title">Document Peraturan</h5>
        <p class="card-text">Peraturan Badan Penanggulangan Bencana Daerah Kota Pekanbaru</p>
        <a href="https://drive.google.com/file/d/1yy0VWG7imQrh0j8PFh_RAGDi68IWa9xw/view?usp=share_link"
